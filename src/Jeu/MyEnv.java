...
public class MyEnv extends EnvironmentDescription {
	public static final String MUR = "Wall";
	public static final String ARCHE = "Arch";
	public static final String BOITE = "Box";
	...
	private void lireBloc(String[] bloc) {
		...
		if (bloc[0].equals("W")) {
			...
			boolean rotation90 = bloc[bloc.length - 1].equals("1") ? true : false;
	...
	private void ajouterRobots(int nbRobots) {
		for (int i = 0; i < nbRobots; i++) {
			Agent robot = new MyRobot(new Vector3d(-5.0 + Math.random() * (5.0 - (-5.0) + 1), 0, -5.0 + Math.random() * (5.0 - (-5.0) + 1)), "Robot " + i);
